...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default=aug_dic["NONE"], help="mode of data augment")
    parser.add_argument("--regular_mode", default=regular_dic["DROPBLOCK"], help="mode of regularization")
    ...
    # Initiate model
    model = Darknet(opt.model_def, regular_mode=opt.regular_mode).to(device)       # default="config/yolov3.cfg"
    ...
    # Get dataloader
    dataset = ListDataset(train_path, augment=True, multiscale=opt.multiscale_training, mode=opt.mode, maxepoch=opt.epochs)
